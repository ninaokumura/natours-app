...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibmluYS1va3VtdXJhIiwiYSI6ImNrd2JiM2E5MDhmZ3Iydm10d3ltbnA4eGoifQ.dsWvfK38CCk0NExH1KmYmQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/nina-okumura/ckwbeqjwq960715lu0a6kt14y',
    // style URL
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') window.location.replace('http://localhost:3000/');
            _context2.next = 10;
            break;
...
// type is either 'passqword' or 'data'
...
var stripe = Stripe('pk_test_51K0E8cCnwRCAEViyHiV7hdRwGnitzWins3JaXGfCXnTYMcvx7iR2bKGymnH7A6SzXYSDlDNW07An9G5tb9DbRM7q00pyKBw1VT');
