...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    // secure: true, // We just want this on prod development
    httpOnly: true, // it will receive the cookie, store it and then send it automatically along with every request.
  };
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // Created an Instance method at userModel.js
...
// Restrict certain routes EX: deleting tour to a certain user role
exports.restrictTo =
  (...roles) =>
  (req, res, next) => {
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // 2) Generate the random token -> created an instance method on userModel.js
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 3) Update changedPasswordAt property for the cur user
